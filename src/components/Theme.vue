<template>
  <div class="container">
    <h1>Темы</h1>
    <button v-if="hasAdminRights || hasTechearRights" class="btn navigate-btn" :onclick="navigateBack">
      Создать
    </button>
    <ul>
...
.container {
  ...
  /* Добавить фон страницы, если нужно */
}
...
.theme-link {
  ...
  color: inherit;
  /* Сохраняем цвет текста при наведении */
}
